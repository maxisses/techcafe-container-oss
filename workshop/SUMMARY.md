...
* [Session 6: Was fehlt “vanilla Kubernetes”?](sessions/session-6-what-lacks-vanilla-k8s/README.md)
  ...
  * [Übung 1: Bauen & Deployen nach OpenShift](sessions/session-6-what-lacks-vanilla-k8s/deploy/README.md)
    ...
    * [Verbinden mit dem Cluster](sessions/session-6-what-lacks-vanilla-k8s/deploy/verbinden-mit-dem-cluster.md)
    * [Deployment per yaml über oc](sessions/session-6-what-lacks-vanilla-k8s/deploy/von-yaml-file.md)
  ...
  * [Übung 2: Logging und Monitoring der Anwendung](sessions/session-6-what-lacks-vanilla-k8s/uebung-2-anwendung-untersuchen/README.md)
    ...
    * [Health Checks - Readiness & Liveness Probes](sessions/session-6-what-lacks-vanilla-k8s/uebung-2-anwendung-untersuchen/healthchecks.md)
