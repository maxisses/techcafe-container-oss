...
* [Session 3: Kubernetes Basics für eure App](sessions/session-3-kubernetes/README.md)
  ...
  * [Übung 1: next stop - Kubernetes Basics](sessions/session-3-kubernetes/uebung-1-next-stop-kubernetes/README.md)
    ...
    * [optional: manuell Skalieren](sessions/session-3-kubernetes/uebung-1-next-stop-kubernetes/optional-manuell-skalieren.md)
    * [optional: Ressourcenlimits Liveness & Readiness Probes // ephemeral Pods](sessions/session-3-kubernetes/uebung-1-next-stop-kubernetes/optional-ressourcenlimits-liveness-and-readiness-probes-ephemeral-pods.md)
    * [optional: Horizontal Pod Autoscaling](sessions/session-3-kubernetes/uebung-1-next-stop-kubernetes/optional-release-and-traffic-management.md)
  * [Übung 2: Kubernetes & Container mit Beispiel-Java Anwendung](sessions/session-3-kubernetes/uebung-2/README.md)
    * [Java Starter Anwendung erstellen](sessions/session-3-kubernetes/uebung-2/java-starter-anwendung-erstellen.md)
    * [Die private Image Registry und Registry Namespaces](sessions/session-3-kubernetes/uebung-2/die-private-image-registry-und-registry-namespaces.md)
...
* [Session 4: -under construction- Continuous Integration / Continuous Delivery mit Kubernetes & Tekton](sessions/part-3/README.md)
  ...
  * [Übung 1: CI/CD Pipeline erstellen und laufen lassen](sessions/part-3/uebung-1-ci-cd-pipeline-erstellen-und-laufen-lassen/README.md)
    * [SetUp checken](sessions/part-3/uebung-1-ci-cd-pipeline-erstellen-und-laufen-lassen/setup-checken.md)
    * [Kubernetes Toolchain erstellen - Git Integration](sessions/part-3/uebung-1-ci-cd-pipeline-erstellen-und-laufen-lassen/kubernetes-toolchain-erstellen-git-integration-and-worker-nodes.md)
    * [Kubernetes Toolchain erstellen - Pipeline Konfiguration](sessions/part-3/uebung-1-ci-cd-pipeline-erstellen-und-laufen-lassen/kubernetes-toolchain-erstellen.md)
    * [Manueller PipelineRun um die Pipeline zu untersuchen](sessions/part-3/uebung-1-ci-cd-pipeline-erstellen-und-laufen-lassen/manueller-pipelinerun-um-die-pipeline-zu-untersuchen.md)
  * [Übung 2: automatisierte PipelineRuns & Tasks](sessions/part-3/uebung-2-automatisierte-pipelineruns-and-tasks/README.md)
